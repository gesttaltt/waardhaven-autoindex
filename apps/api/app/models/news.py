...
from sqlalchemy import (
    ...
    Table, Boolean, Integer, JSON, Index, UniqueConstraint
)
...
class NewsArticle(Base):
    ...
    assets = relationship("Asset", secondary=asset_news_association, back_populates="news_articles")
...
class EntitySentimentHistory(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint('symbol', 'date', name='uq_entity_sentiment_history_symbol_date'),
    )