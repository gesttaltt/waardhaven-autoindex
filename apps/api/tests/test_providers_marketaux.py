...
from app.providers.news import MarketauxProvider, NewsSearchParams, SentimentLabel
...
class TestMarketauxProvider:
    ...
    def test_search_news_success(self, provider, mock_requests):
            ...
            "data": [
                {
                    ...
                    "sentiment": {"score": 0.75, "confidence": 0.9},
        ...
        # Search news
        params = NewsSearchParams(symbols=["AAPL"], limit=10)
